...
cp -r bspwm/config/bspwm $HOME/.config/bspwm/
cp -r bspwm/config/sxhkd/ $HOME/.config/sxhkd/
cp -r bspwm/config/picom $HOME/.config/picom/
cp -r bspwm/config/rofi/ $HOME/.config/rofi/
cp -r bspwm/config/polybar/ $HOME/.config/polybar/
cp -r bspwm/bin/* $HOME/.local/bin/
